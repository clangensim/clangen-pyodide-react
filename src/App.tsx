...
import CatEditPage from "./pages/cats/CatEditPage";
import CatProfilePage from "./pages/cats/CatProfilePage";
import CatDangerousEditPage from "./pages/cats/CatDangerousEditPage";
import RelationshipsPage from "./pages/cats/RelationshipsPage";
import ConditionsPage from "./pages/cats/ConditionsPage";
      ...
      <QueryClientProvider client={queryClient}>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/dens/leaders-den" element={<LeadersDenPage />} />
