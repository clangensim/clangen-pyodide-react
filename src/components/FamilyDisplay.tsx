      ...
      <div className="family__section">
        ...
        <div className="family__section__cats">
          ...
          {family.parents.map((p) =>
            <Link key={`parent_${p.ID}`} className="family__section__cat" to={`/cats/${p.ID}`}>
              <CatDisplay cat={p} />
              {p.name.display}
            </Link>
          )}
      ...
      <div className="family__section">
        ...
        <div className="family__section__cats">
          ...
          {family.siblings.map((p) =>
            <Link key={`sibling_${p.ID}`} className="family__section__cat" to={`/cats/${p.ID}`}>
              <CatDisplay cat={p} />
              {p.name.display}
            </Link>
          )}
      ...
      <div className="family__section">
        ...
        <div className="family__section__cats">
          ...
          {family.children.map((p) =>
            <Link key={`child_${p.ID}`} className="family__section__cat" to={`/cats/${p.ID}`}>
              <CatDisplay cat={p} />
              {p.name.display}
            </Link>
          )}
